package au.com.carsguide.www.util;
...
public class Util extends BasePage {
     ...
     */
    public void selectByIndexFromDropDown(By by) {
        Select select = new Select(driver.findElement(by));
    ...
    public static String getRandomString(int length) {
        ...
        String characters = "abc@gmail.com";
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/au/com/carsguide/www/expedia/screenshots/";
